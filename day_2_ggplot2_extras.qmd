...
### Load the `tidyverse`, `here`, and the cleaned `soldiers` dataset
```{r}
#| eval: true
...
*  Make a interactive boxplot that shows the 
```{r}
my_plot <- soldiers %>% 
...
* Make a tooltip that gives you the subjectid, BMI, heightcm, heightcm, bicepcircumference, and waist circumference
