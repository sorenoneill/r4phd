...
Minimér, maximér og returnér..

![](gfx/rstudio_pane_min_max.gif)

## Ændre størrelse på panelerne 

Menu og tastatur genveje..

![](gfx/rstudio_pane_resize_menu.gif)
...
3. Brug hjælpefunktionen til at afgøre hvordan du kan bruge R til at finde ud af hvilken version af R du har installeret på din computer.
...
3. Bemærk, at der er to søgefelter på 'help' fanebladet i 'Output' panelet -- brug den til højre til at lære mere om (base)funktionen R.Version.
4. I Environment fanebladet i Environment panelet, skulle du se en liste af 'Values' hvor 'a' er '5'.
