...
![](gfx/RR/comments_r_vs_quarto.png)
...
Firstly, did you notice the red squiggly lines and the warning symbol in the left margin of line 17? ![](gfx/RR/comments_r_vs_quarto_warning.png).
...
Okay so. Line 17 was not valid R code. The line was actually a _single-line markdown comment_ and it belongs in markdown and **not** inside an R code chunk. 
