...
Some of these packages have a very specific and narrow forus -- e.g. Steen Harsteds packages for handling _motion capture_ data called [RMoCap]("https://github.com/steenharsted/RMoCap"). Other packages er more generic and you will get to know some of them during the course. For instance:
