...
The **raw** data is the unadulterated version of the data as collected by what-ever-means: questionnaires, machine readings, etc. You should always keep a version of the raw data in its original form.     
