...
Hvert _panel_ i RStudio har som regel adskillige fanebalde. For eksempel, i billedet herover, indeholder 'Output' panel fanebladene **Files**, **Plots**, **Packages**, **Help**, **Viewer** og **Presentation**.

Bemærk, at de faneblade som ses vil variere afhængigt hvad type dokument du arbejder med. For eksempel om du arbejder på en præsentation eller en hjemmeside. Tilsvarende vil visse ekstra funktioner, som eksempelvis Git versionerings kontrol, være tilgængelig på et faneblade _hvis_ altså den er i brug. 
